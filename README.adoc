...
:cert-manager-chart-version: 1.14.4
:chart-url: https://github.com/cert-manager/cert-manager/tree/master/deploy/charts/cert-manager

A https://modern-gitops-stack.io[Modern Gitops Stack] module for installing and configuring https://cert-manager.io/[cert-manager].
...
*Since this module is meant to be instantiated using its variants, the usage documentation is available in each variant* ( xref:./aks/README.adoc[AKS] | xref:./eks/README.adoc[EKS] | xref:./self-signed/README.adoc[Self-signed] ).
